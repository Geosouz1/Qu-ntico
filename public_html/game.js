class Game{
	constructor(){
		...
		options.assets.push(`${game.assetsPath}fbx/escola9.fbx`);
	...
	loadEnvironment(loader){
		const game = this;
		loader.load(`${this.assetsPath}fbx/escola9.fbx`, function(object){
...
class Player{
	constructor(game, options){
		...
		loader.load( `${game.assetsPath}fbx/newPeople/${model}.fbx`, function ( object ) {
